...
import man from "./images/indian_businessman-removebg-preview (1).png";
...
export const Intro = () => {
  return (
    ...
    <div className="mx-auto lg:mx-0">
        <Image src={man} alt="cartoon" className="w-[300px] lg:w-[400px] h-[300px] lg:h-[500px] object-cover" />
    </div>
    ...
    <div className="w-full lg:w-[80%] flex flex-col justify-center h-auto lg:h-full mx-auto lg:mx-10 text-center lg:text-left my-4 lg:my-0">
        ...
        <a href="src\app\components\File\Percy-Djiwornu-Konotey-FlowCV-Resume-20240523.pdf" download className="bg-gray-900 font-bold font-mono p-2 border border-green-300 text-white rounded-3xl mt-2 flex items-center justify-center lg:justify-start w-[50%] lg:w-[12%] gap-2 hover:bg-pink-200 hover:text-black transition duration-500 transform hover:scale-110 mx-auto lg:mx-0">
            Download CV
