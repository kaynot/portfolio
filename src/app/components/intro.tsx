      ...
      <div className="w-full h-[500px] flex  ">
        ...
        <div className=" w-[80%] flex flex-col justify-center h-full mx-10 ">
          ...
          <a
            ...
            download
            className=" bg-gray-900  font-bold font-mono p-2 border border-green-300 text-white rounded-3xl mt-2 flex items-center w-[12%] gap-2  hover:bg-pink-200  hover:text-black transition duration-500 transform hover:scale-110"
          >
            Download CV
            <AiOutlineDownload
              size={20}
              color="white"
              className="lg:text-4xl animate-bounce"
            />
          </a>
        </div>
